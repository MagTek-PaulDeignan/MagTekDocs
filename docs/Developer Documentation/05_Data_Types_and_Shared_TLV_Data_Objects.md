...
The example track data in [Table 4.21](#table-4-21) can be interpreted as follows:
...
### [Table 4.105](#table-4-105) - Discover D-PAS Entry Point Table
...
### [Table 4.106](#table-4-106) – China Unionpay Entry Point Table
...
### [Table 4.107](#table-4-107) - JCB Entry Point Table
...
### [Table 4.108](#table-4-108) – Interac Flash Entry Point Table
...
MagTek provides tools that allow these settings to be loaded using a Microsoft Excel spreadsheet in xlsx format for more convenient authoring, review, and change tracking. For a reference sample spreadsheet, contact MagTek Support Services. The MagTek tools expect the spreadsheet to be formatted format as shown in [Table 4.111](#table-4-111). Each CA Key to be supported is defined in a tab of the Excel file.

### [Table 4.111](#table-4-111) - EMV Configuration CA Keys File Type
...
The MagTek tool converts the spreadsheet data into the format shown in [Table 4.112](#table-4-112).

### [Table 4.112](#table-4-112) - CA Keys Raw Format
...
MagTek provides tools that allow these settings to be loaded using a Microsoft Excel spreadsheet in xlsx format for more convenient authoring, review, and change tracking. For a reference sample spreadsheet, contact MagTek Support Services. The MagTek tools expect the spreadsheet to be formatted as shown in [Table 4.121](#table-4-121). Each DRL to be supported is defined in a tab of the Excel file.

### [Table 4.121](#table-4-121) - EMV Configuration American Express DRL Set File Type
...
The MagTek tool converts the spreadsheet data into the raw format shown in [Table 4.122](#table-4-122):

### [Table 4.122](#table-4-122) -Raw EMV Configuration American Express DRL Set File Type
...
The signature capture file type produced when the host invokes **Command 0x1801 - Request Cardholder Signature (Touch Only)** is a TLV data object in the format below.

### [Table 4.131](#table-4-131) - Signature Capture File Type

| Tag | Len | Value / Description                                                                                                                                                                                                                                                                 | Typ | Req | Default                                                        |
|-----|-----|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----|-----|----------------------------------------------------------------|
| 81  | 08  | Signature Window Width and Height Bytes 0..1 = Left edge (minimum value of all X coordinates) Bytes 2..3 = Right edge (maximum value of all Y coordinates) Bytes 4..5 = Top edge (minimum value of all Y coordinates) Bytes 6..7 = Bottom edge (maximum value of all Y coordinates) | B   | R   | 0000 00FD 0000 0078 (landscape) 0000 00C8 0000 00B9 (portrait) |
...
### [Table 4.141](#table-4-141) - Security Operation Type
...
### [Table 4.151](#table-4-151) - Security Parameters Type

| Tag | Len | Value / Description                                                                                                                                                          | Typ | Req | Default |
|-----|-----|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----|-----|---------|
| 81  | var | Operation This contains an instance of a **Security Operation Type** structure specifying the operation to be performed.                                                     | B   | R   |         |
...
### [Table 4.161](#table-4-161) - Key Information Type

| Tag | Len | Value / Description                                               | Typ | Req | Default |
|-----|-----|-------------------------------------------------------------------|-----|-----|---------|
| 81  | 02  | Key Slot ID Identifies the key being used for operation. See \*\* |     |     |         |
|     |     |                                                                   |     |     |         |

### [Table 4.196](#table-4-196) - Key Slot IDs\*\*. \| B \| R \| \|

\| 82 \| var \| Key Label The label that indicates the key type. For example, **DEVTK**. \| AN \| O \| \| \| 86 \| var \| Key Derivation Details Use Key Serial Number (KSN) in requests, Key Derivation Information in responses. \| B \| O \| \| \| 88 \| var \| Additional Information Reserved for future use. Do not include. \| B \| O \| \|

## NFC UID Type (EMV Contactless Only)

### [Table 4.171](#table-4-171) – NFC UID Type
...
### [Table 4.181](#table-4-181) – NFC UID Type
...
### [Table 4.191](#table-4-191) - TR-31 Block Fixed Header

| Offset | Name             | Fixed Value | Variable                                                                                                                         |
|--------|------------------|-------------|----------------------------------------------------------------------------------------------------------------------------------|
| 0      | Key Block V ID   | ‘D’         |                                                                                                                                  |
| 1..4   | Key Block Length |             | Calculated (in decimal, e.g. 138 bytes shown as ‘0138’                                                                           |
| 5..6   | Usage            |             | Look up the desired **Key Type** in [Table 4.192](#table-4-192) **below** and select this value from the **Usage** column.       |
| 7      | Algorithm        |             | Look up the desired **Key Type** in [Table 4.192](#table-4-192) **below** and select this value from the **Algorithm** column.   |
| 8      | Mode of Use      |             | Look up the desired **Key Type** in [Table 4.192](#table-4-192) **below** and select this value from the **Mode of Use** column. |
| 9..10  | Key Version \#   | ‘00’        | Always ‘00’                                                                                                                      |
| 11     | Exportability    | ‘N’         | Always no export allowed                                                                                                         |
| 12..13 | \# option blocks |             | Calculated                                                                                                                       |
| 14..15 | Reserved         | ‘00’        |                                                                                                                                  |

### [Table 4.192](#table-4-192) - TR-31 Key Type Table - Usage/Algorithm/Mode
...
### [Table 4.193](#table-4-193) - TR-31 Optional Blocks
...
| ‘21’ | MagTek Additional Key Info From \*\*                                        |
|      |                                                                             |

### [Table 4.194](#table-4-194) - MagTek Custom TR-31 Small Optional Block\*\* \|
...
### [Table 4.195](#table-4-195) - MagTek Custom Key Data Fields

| Field ID | Length | Purpose                                               |
|----------|--------|-------------------------------------------------------|
| ‘10’     | ‘01’   | Key Environment T = Test P = Production 0 = Erase Key |
| ‘11’     | ‘04’   | Key Slot ID See \*\*                                  |
|          |        |                                                       |

### [Table 4.196](#table-4-196) - Key Slot ID\*\*. \|

\| ‘12’ \| ‘04’ \| Key Slot ID of Transport Key \| \| ‘20’ \| -- \| Reserved \| \| ‘21’ \| ‘04’ \| DUKPT Data Type Restriction Bitmask This is for Transport Keys and DUKPT keys. Default to 0. \| \| ‘31’ \| ‘07’ \| Device Serial Number \| \| ‘32’ \| ‘10’ \| Challenge Token 10h = 16 characters \| \| ‘33’ \| ‘10’ ..‘18’ \| Expiration Date/Time This is in UTC format, use short form if possible. Reserved. \|

### [Table 4.196](#table-4-196) - Key Slot IDs
...
### [Table 4.197](#table-4-197) - SRED Data IDs and OIDs
...
### [Table 4.198](#table-4-198) - Transformation IDs for DUKPT Legacy and AES
...
### [Table 4.199](#table-4-199) - The definition of Restriction bit map
...
a). The DUKPT Slot ID must be loaded. ([Table 4.191](#table-4-191)**0**)

b). The loaded DUKPT Slot ID must allows this type of SRED Data ID. ([Table 4.199](#table-4-199)\*\*)\*\*

c). The transformation must be allowed by [Table 4.191](#table-4-191)**1**.
...
### [Table 4.191](#table-4-191)0 - Settings of Injected DUKPT Slot IDs
...
### [Table 4.191](#table-4-191)1 - Allowed Key Mapping Table
...
### [Table 4.201](#table-4-201) - Miniature Certificate Type
...
### [Table 4.221](#table-4-221) - Response Track Type
...
### [Table 4.231](#table-4-231) - Response Card Data Type (wip)
...
### [Table 4.261](#table-4-261) - Common File Structure

| Tag                                 | Len | Value / Description                                                                                   | Typ | Req | Default |
|-------------------------------------|-----|-------------------------------------------------------------------------------------------------------|-----|-----|---------|
| **MGTKAP10** = Start Of File Marker |     |                                                                                                       |     |     |         |
| C1                                  | 4   | File Type See [Table 6.71](#table-6-71)                                                               | B   | R   | N/A     |
| CE                                  | var | File Payload See the “File Type” subsections of section **4 Data Types and Shared TLV Data Objects**. | B   | R   | N/A     |

## Certificate File Types

These file types are listed in [Table 6.71](#table-6-71).
...
**![A screenshot of a computer Description automatically generated](media/7a699969a6ed1d2b076080dbe85470c6.png)**
...
“Signed UI configuration file”. The format of the “Signed UI configuration file” is shown in

### [Table 4.291](#table-4-291) - Format of a Signed UI Configuration File.
...
|----------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| ![A screenshot of a computer screen Description automatically generated](media/558b86e02d8107b162fb593fc2e6f090.png) | **![A screenshot of a computer Description automatically generated](media/7a699969a6ed1d2b076080dbe85470c6.png)** |
...
### [Table 4.292](#table-4-292) - Format of an UI Configuration File Signing Mini-cert Signed by the Base Mini-cert
...
-   Step \#7: Validate the signature per SECG – SEC1 Elliptic Curve Cryptography, Version 2.0, [Section 4.1.4](#section-4-1-4). (SECG = Standards for Efficient Cryptography Group)
...
-   Step \#8: Validate the signature per SECG – SEC1 Elliptic Curve Cryptography, Version 2.0, [Section 4.1.4](#section-4-1-4). (SECG = Standards for Efficient Cryptography Group)
